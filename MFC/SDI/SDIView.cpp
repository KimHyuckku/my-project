...
BEGIN_MESSAGE_MAP(CSDIView, CView)
	...
	ON_COMMAND(ID_THEADBEGIN, &CSDIView::OnTheadbegin)
	ON_COMMAND(ID_THREADEND, &CSDIView::OnThreadend)
	ON_UPDATE_COMMAND_UI(ID_THEADBEGIN, &CSDIView::OnUpdateTheadbegin)
...
void CSDIView::OnUpdateTheadbegin(CCmdUI* pCmdUI)
{
