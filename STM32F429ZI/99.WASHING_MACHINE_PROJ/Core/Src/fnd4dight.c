...
void fnd4digit_timer(unsigned int set_time);
void fnd4digit_timer2(unsigned int set_time);
void FND_turnspin(unsigned int value);
...
uint32_t FND_spin[6] =
{
		FND_b|FND_c|FND_d|FND_e|FND_f,
  FND_a|	  FND_c|FND_d|FND_e|FND_f,
  FND_a|FND_b|		FND_d|FND_e|FND_f,
  FND_a|FND_b|FND_c|	  FND_e|FND_f,
  FND_a|FND_b|FND_c|FND_d|		FND_f,
  FND_a|FND_b|FND_c|FND_d|FND_e
};
...
void FND_update(unsigned int value)
{
	...
	FND[1] = FND_font[value / 10 % 6];
	FND[2] = FND_font[value / 60 % 10];
	FND[3] = FND_font[value / 600 % 10];

	return;
}

void FND_downdate(unsigned int value1, unsigned int value2)
{
	FND[0] = FND_font[(value1-value2) % 10];
	FND[1] = FND_font[(value1-value2) / 10 % 6];
	FND[2] = FND_font[(value1-value2) / 60 % 10];
