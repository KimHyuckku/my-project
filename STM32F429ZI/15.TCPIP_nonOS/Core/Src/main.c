...
extern void get_DHT11(char *tmp);	//
extern void get_DHT11_tmp(char *tmp);	//
extern void get_DHT11_rh(char *tmp);	//
...
//------ TCP/IP start -------------
	...
	upcb1 = udp_new();                //Add
	IP4_ADDR(&addr1,10,10,15,57);     //Add My PC IP
